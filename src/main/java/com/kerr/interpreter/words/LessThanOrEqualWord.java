 ...
 * is less than or equal to the top integer or false if it isn't.
 * 
 * @author allankerr
 *
 */
class LessThanOrEqualWord extends PredefinedWord {
   ...
   * integer is less than or equal to the top integer or false if it isn't.
   * 
